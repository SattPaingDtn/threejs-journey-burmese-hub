# 📐 Three.js Journey - Lesson 04: Transform Objects (အရာဝတ္ထုများ ရွှေ့ပြောင်းခြင်းနှင့် စီမံခြင်း)
...
> **ချဉ်းကပ်မှုပုံစံ**: Medium / Balanced Deep Dive (ရုပ်ပုံကားချပ်များ၊ သင်္ချာရှင်းလင်းချက်နှင့် လက်တွေ့ ကုဒ်နမူနာများ)
...
7. [အမြန်မှတ်စု (Lesson 04 Memo & Cheat Sheet)](#၇-အမြန်မှတ်စု-lesson-04-memo--cheat-sheet)
...
# ၇။ အမြန်မှတ်စု (Lesson 04 Memo & Cheat Sheet)
...
mesh.position.distanceTo(camera.position)     // Distance to camera
mesh.position.normalize()                     // Reduce length to 1
...
// ==========================================
// ROTATION (Euler & LookAt)
// ==========================================
mesh.rotation.reorder('YXZ')                  // Prevent Gimbal lock
mesh.rotation.y = Math.PI * 0.5               // 90 degrees in radians
camera.lookAt(mesh.position)                  // Aim camera at target

// ==========================================
// AXES HELPER & GROUP
// ==========================================
scene.add(new THREE.AxesHelper(2))            // Red=X, Green=Y, Blue=Z
const group = new THREE.Group()
